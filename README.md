...
8. Switching to the experimental **Indvidual Detection** task. The user can select from the list of crocodiles detected  obtained the earlier detection task from the drop down list. 
9. The **Estimate Pose** button will run a pose estimation on the image, and the results are tabulated.
